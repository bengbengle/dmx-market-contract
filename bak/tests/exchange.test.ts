...
export function runExchangeTests(
  ...
  describe('Exchange', function () {
    ...
    describe('permissions', runPermissionsTests(async () => {
        return setupTest({
          price,
          feeRate,
          setupExchange,
    ...
    describe('validateSignatures', runSignatureTests(async () => {
        return setupTest({
          price,
          feeRate,
          setupExchange,
    ...
    describe('matchingPolicies', runMatchingPolicyTests(async () => {
